                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-5">
                                    <div class="welcome-back-img pt-4">
                                        <img src="{{ asset('backend/assets/images/m4.jpeg') }}"
                    ...
                    <div class="card w-100 rounded-4">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-center mt-3">
                                <img src="{{ asset('backend/assets/images/m5.jpeg') }}" alt="Deskripsi gambar"
                                    class="img-fluid rounded-3" style="object-fit: cover; height:250px; width:100%;">
                            </div>
                            <hr>
                            <div class="d-flex justify-content-center">
                                {{-- <a href="{{ route('product.show') }}" class="btn btn-outline-secondary w-100 raised"
                                    type="submit">see details</a> --}}
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-xxl-3 d-flex align-items-stretch">
                    <div class="card w-100 rounded-4">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-center mt-3">
                                <img src="{{ asset('backend/assets/images/m4.jpeg') }}" alt="Deskripsi gambar"
                                    class="img-fluid rounded-3" style="object-fit: cover; height:250px; width:100%;">
                            </div>
                            <hr>
                            <div class="d-flex justify-content-center">
                ...
                <div class="col-xl-6 col-xxl-3 d-flex align-items-stretch">
                    <div class="card w-100 rounded-4">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-center mt-3">
                                <img src="{{ asset('backend/assets/images/m6.jpeg') }}" alt="Deskripsi gambar"
                                    class="img-fluid rounded-3" style="object-fit: cover; height:250px; width:100%;">
                            </div>
                            <hr>
                            <div class="d-flex justify-content-center">
                ...
                <div class="col-xl-6 col-xxl-3 d-flex align-items-stretch">
                    <div class="card w-100 rounded-4">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-center mt-3">
                                <img src="{{ asset('backend/assets/images/m1.jpeg') }}" alt="Deskripsi gambar"
                                    class="img-fluid rounded-3" style="object-fit: cover; height:250px; width:100%;">
                            </div>
                            <hr>
                            <div class="d-flex justify-content-center">
