        ...
        <div class="card-body p-4">
            ...
            <form class="row g-3" method="POST" action="{{ route('user.update', $user->id) }}">
                ...
                <div class="col-md-4x">
                    ...
                    <div class="position-relative input-icon">
                        <input type="text" name="residence" class="form-control @error('residence') is-invalid @enderror" id="input14" value="{{ old('residence') }}" placeholder="Full residence" required>
                        <span class="position-absolute top-50 translate-middle-y"><i class="material-icons-outlined fs-5">Residence</i></span>
                        @error('residence')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="col-md-4x">
                    ...
                    <div class="position-relative input-icon">
                        ...
                        <span class="position-absolute top-50 translate-middle-y"><i class="material-icons-outlined fs-5">Gender</i></span>
                        @error('gender')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
