...
<head>
  ...
  <!-- Favicon -->
  <link rel="icon" type="image/x-icon" href="{{ asset('frontend/assets/img/favicon/favicon.ic') }}" />
  ...
  <link rel="stylesheet" href="{{ asset('frontend/assets/vendor/css/theme-default.css') }}" />
